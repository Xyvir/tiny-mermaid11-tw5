...
- [x] 07-03-PLAN.md — Format B→A migration batch 2: Entity Relationship, Gantt, Pie, Requirement, C4 (wave 2)
- [x] 07-04-PLAN.md — Expand 9 existing Format A tiddlers + Block/Timeline legends (wave 2)
- [x] 07-05-PLAN.md — 6 net-new beta-type tiddlers: Radar, Venn, Ishikawa, Treemap, Tree View, Wardley (wave 2)
